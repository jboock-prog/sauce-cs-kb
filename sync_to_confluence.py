...
def inline_fmt(s):
    # Escape HTML special chars before inserting any tags so bare & < > in
    # source text don't produce invalid XHTML sent to Confluence.
...
def parse_entries(filepath):
    ...
    # Split on entry headings: ## Entry XXX-N: Title or ## Entry N: Title
    pattern = r"(## Entry [\w-]+: .+)"
